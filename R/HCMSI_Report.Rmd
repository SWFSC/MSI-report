---
title: "SOURCES OF HUMAN-RELATED INJURY AND MORTALITY FOR U.S. PACIFIC WEST COAST MARINE MAMMAL STOCK ASSESSMENTS, 2020-2024"
...
# set local file path where SeriousInjuryExtract.R lives
# note this is where report will initially be saved
source("C:/jeff/github/MSI-report/R/SeriousInjuryExtract.R") 
...
Jeffrey Moore^1^, James V. Carretta^1,+^, Justin Greenman^2^, Kristin Wilkinson^3^, Lauren Saez^4^, Dan Lawson^3^, Justin Viezbicke^2^, and K. Alexandra Curtis^1^
...
The data summarized in this report is available as a [CSV file at GitHub](https://github.com/SWFSC/MSI-report/blob/main/data/2020_2024_5yr_MSI.csv).

<!-- Data from previous years is [available here.](https://github.com/SWFSC/MSI-report/blob/main/data/Anthropogenic.MSI.Cases.AllYears.csv) -->
...
[Curtis, K.A. J. Calambokidis, K. Audley, E.A. Becker, J.K. Byington, J.V. Carretta, P. Cabanilles, M.G. Castaneda, T. Cheeseman, J. Currie, J. De Weerdt, N. Doe, K. Flynn, K.A. Forney, A. Frisch-Jordán, C. Gabriele12, J.L. Huggins, M. Jones, P. Martínez-Loustalot, C.J. McMillan, A.A. Pack, E. Quintana-Rizzo, N. Ransome, J. Urbán R., M. van Aswegen, and J.E. Moore. 2025. Harnessing the power of photo-ID data for apportionment to migratory whale herds: U.S. West Coast humpback whale stock proportions by latitude for the period 2019-2024.](https://doi.org/10.25923/ah7d-sj35)<p>
...
[Rockwood, R.C., Calambokidis, J. and Jahncke, J., 2017. High mortality of blue, humpback and fin whales from modeling of vessel collisions on the US West Coast suggests population impacts and insufficient protection. PLoS One, 12(8), p.e0183052.](https://doi.org/10.1371/journal.pone.0183052)<p>
